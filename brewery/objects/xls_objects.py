...
try:
    ...
    xlrd = MissingPackage("xlrd", "Reading MS Excel XLS Files",
                          "http://pypi.python.org/pypi/xlrd")

class XLSDataSource(DataObject):
    """Reading Microsoft Excel XLS Files

    Requires the xlrd package.
    """
    def __init__(self, resource, sheet=None, encoding=None, skip_rows=None,
                 read_header=True):
    ...
    def _initialize(self):
        ...
        self.handle, self.close_file = base.open_resource(self.resource)

        self.workbook = xlrd.open_workbook(file_contents=self.handle.read(),
